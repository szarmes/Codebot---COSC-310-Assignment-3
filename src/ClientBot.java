...
public class ClientBot {
        ...
        /*
         * this method connects the clientbot to the socket in order to have a conversation with
         * serverbot
         */
        public void run() throws Exception{
		            
		      mySkt = new Socket("localhost", 9999); //change the string to the proper IP address of the server. In this case it is my IP
		      												//using "localhost" will work fine if you want to do it locally
        ...
        /*
         * this method constantly reads the server for a new line from serverbot, and then responds to it with the proper
         * codebot response
         */
        ...
        public void socketRespond() throws Exception{
		    ...
		    String temp;
		    if((temp = myBR.readLine()) != null) {
		    	System.out.println(respond(temp));
		   
		    	myPS.println(respond(temp));
		    	 socketRespond();
		    }
